...
# Or step-by-step:
apipay login                  # Authenticate (browser approval or email/password)
...
| Command | Description |
|---------|-------------|
| `apipay login` | Sign in by approving from an already logged-in browser or with email/password |
...
| Command | Description |
|---------|-------------|
| `apipay banks:add` | Add a supported bank account |
