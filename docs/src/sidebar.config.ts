...
export const viSidebarConfig: SidebarItem[] = [
  ...
  {label: 'Sandbox & Live Test', href: '/vi/sandbox'},
  {
  ...
  },
  {
    ...
    children: [
      ...
      {label: 'MCP Server', href: '/vi/integrations/mcp'},
...
export const enSidebarConfig: SidebarItem[] = [
  ...
  {label: 'Sandbox & Live Test', href: '/en/sandbox'},
  {
  ...
  },
  {
    ...
    children: [
      ...
      {label: 'MCP Server', href: '/en/integrations/mcp'},
